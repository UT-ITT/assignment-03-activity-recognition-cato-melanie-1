...
## Acticity Recognition (10/10P)
* the program loads training data correctly
    * yep (1P)
* training data is pre-processed appropiately
    * yep, we would've expected an FFT, but it works really good (2P)
...
## Bonus Points (1P)
In comparision with our data set you won **3rd Place!** You get a Bonus Point! 